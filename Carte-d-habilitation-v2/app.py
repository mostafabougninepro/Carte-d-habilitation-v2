...
# دالة البحث عن الصورة داخل مجلدات photo A و photo B
    ...
    for folder in photo_folders:
        if os.path.exists(folder):
            for filename in os.listdir(folder):
                ...
                # مطابقة دقيقة بدون التأثر بالحروف الكبيرة أو الصنع
...
# القراءة المباشرة للصورة عبر الماتريكيل المدخل فـ البحث
auto_photo_path = get_agent_photo(matricule_search.strip())
